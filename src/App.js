...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    this.db.collection("products").onSnapshot((snapshot) => {
      // using this onSnapshot function this is possible real time update on sever while firebase update
      console.log(snapshot);
  ...
  addProduct = () => {
    this.db
      ...
      .then((docRef) => {
        //docRef is a objects of add(ing,price,Qty etc.)
    ...
    return (
      <div className="App">
        ...
        {loading && (
          <>
            <img
              src="https://boldist.co/wp-content/uploads/2021/04/Loading-Spinners-are-UX-Killers.gif"
              style={styles.img}
            ></img>
        ...
        <div style={styles.div}>
          <strong>TOTAL: {this.getCartTotal()}</strong>
        </div>
      </div>
    );
  }
